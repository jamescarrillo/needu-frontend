									...
									<ul>
										<li>
											<a href="#">
												...
												<h3 class="clearfix">David Villavicencio</h3>
									...
									<div class="right text-right">
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right">
												<a class="dropdown-item" href="#">Exportar Chat</a>
												<a class="dropdown-item" href="#">Buscar</a>
												<a class="dropdown-item text-light-orange" href="#">Eliminar Chat</a>
											</div>
										</div>
									</div>
								</div>
