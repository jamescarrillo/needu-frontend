	...
	<div class="main-container">
		<div class="pd-ltr-20 customscroll customscroll-10-p height-100-p xs-pd-20-10">
			<div class="row clearfix progress-box">
				<div class="col-12">
					<h4 class="text-center font-weight-bold mb-10">
						Terapia Psicológica Positiva y Áreas de Atención
					</h4>
				</div>
					...
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								...
								<p class="weight-400 font-18">Psicología Adolescentes 
						...
						<div class="project-info-progress">
							<div class="row clearfix">
								<div class="col-sm-6 text-muted weight-500">N° Psicólogos</div>
					...
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								...
								<p class="weight-400 font-18">Psicología Adultos
									<span><i class="fa fa-question-circle" aria-hidden="true"></i></span> 
								</p>
							</div>
						</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-light-orange weight-500 font-24">35</span>
								<p class="weight-400 font-18">Terapia Pareja y Familia
									<span><i class="fa fa-question-circle" aria-hidden="true"></i></span> 
								</p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
								<div class="col-sm-6 text-muted weight-500">N° Psicólogos</div>
								<div class="col-sm-6 text-right weight-500 font-14 text-muted">35</div>
							</div>
							<div class="progress" style="height: 10px;">
				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-light-purple weight-500 font-24">22</span>
								<p class="weight-400 font-18">Psicología de Grupo 
									<span><i class="fa fa-question-circle" aria-hidden="true"></i></span> 
								</p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
								<div class="col-sm-6 text-muted weight-500">N° Psicólogos</div>
								<div class="col-sm-6 text-right weight-500 font-14 text-muted">22</div>
							</div>
							<div class="progress" style="height: 10px;">
			...
			<!--div class="bg-white pd-20 box-shadow border-radius-5 mb-30">
				<h4 class="mb-30">Estadísticas de Casos de éxito</h4>
				<div class="row">
			...
			<div class="row justify-content-center mb-z20" style="margin-bottom: 200px">
				<div class="col-lg-4 col-sm-6 col-12">
					<button class="btn btn-info btn-block">Explorar más Áreas de Atención</button>
				</div>
			</div>
